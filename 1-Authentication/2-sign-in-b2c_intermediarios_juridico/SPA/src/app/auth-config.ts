...
export const b2cPolicies = {
    ...
    authorities: {
        signUpSignIn: {
        authority: 'https://PISEDevt.b2clogin.com/PISEDevt.onmicrosoft.com/B2C_1_Intermediario_Juridico_Signin',
        },
        resetPassword: {
          authority: 'https://PISEDevt.b2clogin.com/PISEDevt.onmicrosoft.com/B2C_1_Intermediario_Juridico_ResetPassword',
        },
        editProfile: {
          authority: '',
        },
