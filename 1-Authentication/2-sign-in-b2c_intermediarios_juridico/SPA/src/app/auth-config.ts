...
export const b2cPolicies = {
    names: {
    signUpSignIn: 'B2C_1_Intermediario_Juridico_Signin',
    resetPassword: 'B2C_1_Intermediario_Juridico_ResetPassword',
    editProfile: '',
    },
    authorities: {
        signUpSignIn: {
        authority: 'https://SEProveedoresDev.b2clogin.com/SEProveedoresDev.onmicrosoft.com/B2C_1_Intermediario_Juridico_Signin',
        },
        resetPassword: {
          authority: 'https://SEProveedoresDev.b2clogin.com/SEProveedoresDev.onmicrosoft.com/B2C_1_Intermediario_Juridico_ResetPassword',
        },
        editProfile: {
          authority: 'https://SEProveedoresDev.b2clogin.com/SEProveedoresDev.onmicrosoft.com/',
        },
    },
