...
export const b2cPolicies = {
    ...
    authorities: {
        signUpSignIn: {
        authority: 'https://SEProveedoresDev.b2clogin.com/SEProveedoresDev.onmicrosoft.com/B2C_1_Tomador_Juridico_SISU',
        },
        resetPassword: {
          authority: 'https://SEProveedoresDev.b2clogin.com/SEProveedoresDev.onmicrosoft.com/B2C_1_Tomador_Juridico_ResetPassword',
        },
        editProfile: {
          authority: 'https://SEProveedoresDev.b2clogin.com/SEProveedoresDev.onmicrosoft.com/B2C_1_Tomador_Juridico_EditProfile',
        },
    },
